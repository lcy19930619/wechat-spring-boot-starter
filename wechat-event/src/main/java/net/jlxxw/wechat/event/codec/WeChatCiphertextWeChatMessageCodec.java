 ...
 * @author lcy
 */
public class WeChatCiphertextWeChatMessageCodec implements WeChatMessageCodec {
    ...
    public WeChatCiphertextWeChatMessageCodec(WeChatProperties weChatProperties) throws AesException {
    ...
    public String decrypt(String uri, String data) throws AesException {
        ...
        */
        ...
        return decrypt(msgSignature,timestamp,nonce,data);
    }

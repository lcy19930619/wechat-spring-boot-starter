...
public class SubscribeScanEventMessageTest extends BaseTest {
    ...
    public void convertTest() throws IOException {
        ClassPathResource classPathResource = new ClassPathResource("mock/data/xml/event/SubscribeScanEventMessage.xml");
    ...
    public void sendTest() throws IOException {
        String xmlData = readXmlData("mock/data/xml/event/SubscribeScanEventMessage.xml");

草稿箱开关设置:https://developers.weixin.qq.com/doc/service/api/draftbox/draftmanage/api_draft_switch.html
...
获取草稿的总数:https://developers.weixin.qq.com/doc/service/api/draftbox/draftmanage/api_draft_count.html
